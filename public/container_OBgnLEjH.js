    ...
    window.MatomoTagManager = (function () {
      ...
      function j() {
        if (
          ...
          "object" === typeof window.mtmPreviewWindow.mtmLogs
        ) {
          var G = new Date();
          var I = [];
      ...
      function d(G) {
        if (
          window.mtmPreviewWindow &&
          "object" === typeof window.mtmPreviewWindow.mtmEvents &&
          G
        ) {
          var i = new Date();
        ...
        this.get = function (i) {
          if (i in this.values) {
            if (B.isFunction(this.values[i])) {
              ...
              if (
                B.isObject(this.values[i]) &&
                B.isFunction(this.values[i].get)
              ) {
        ...
        parseUrl: function (i, J) {
          try {
            ...
            if ("origin" === J && "protocol" in K && K.protocol) {
              return (
                K.protocol + "//" + K.hostname + (K.port ? ":" + K.port : "")
              );
            }
            return;
          } catch (I) {
      ...
      var D = {
            ...
            for (I = 0; I < this.scrollListenEvents.length; I++) {
              if (b.removeEventListener) {
                a.removeEventListener(
                  this.scrollListenEvents[I],
                  this.didScroll,
                  true
                );
              } else {
                a.detachEvent(
                  "on" + this.scrollListenEvents[I],
                  this.didScroll
                );
              }
            }
        ...
        getViewportWidth: function () {
          var i =
            a.innerWidth || b.documentElement.clientWidth || b.body.clientWidth;
          if (!i) {
            return 0;
          }
          return i;
        ...
        getPerformanceTiming: function (i) {
          if (
            "performance" in a &&
            B.isObject(a.performance) &&
            B.isObject(a.performance.timing) &&
      ...
      var A = {
        ...
        getScrollLeft: function () {
          return (
            a.document.body.scrollLeft || a.document.documentElement.scrollLeft
          );
        },
        getScrollTop: function () {
          return (
            a.document.body.scrollTop || a.document.documentElement.scrollTop
          );
        },
        ...
        shouldElementBeMasked: function (G) {
          ...
          if (
            G.hasAttribute("data-matomo-mask") ||
            G.hasAttribute("data-piwik-mask")
          ) {
            return true;
          }
          if (
            G.hasAttribute("data-matomo-unmask") ||
            G.hasAttribute("data-piwik-unmask")
          ) {
            return false;
          }
          ...
          while (i) {
            ...
            if (
              i.hasAttribute("data-matomo-unmask") ||
              i.hasAttribute("data-piwik-unmask")
            ) {
              return false;
            }
            i = i.parentElement;
        ...
        elementHasMaskedChild: function (i) {
          ...
          return (
            i.querySelector("[data-matomo-mask],[data-piwik-mask]") !== null
          );
        },
      ...
      function m(I, G) {
        ...
        function H(K) {
          return (
            ...
            B.isObject(K) &&
            !B.isArray(K) &&
            (B.hasProperty(K, "type") || B.hasProperty(K, "joinedVariable"))
          );
        }
        function J(M) {
      ...
      function s(H, G) {
        ...
        this.get = function () {
          ...
          if (
            (!B.isDefined(L) || L === null || L === false) &&
            B.isDefined(this.defaultValue)
          ) {
            L = this.defaultValue;
          }
          var K;
        ...
        this.toString = function () {
          if (
            this.theVariable &&
            B.hasProperty(this.theVariable, "toString") &&
            B.isFunction(this.theVariable.toString)
          ) {
            try {
      ...
      function f(I, G) {
        ...
        this.setUp = function () {
          if (
            ...
            B.isFunction(this.theTrigger.setUp)
          ) {
      ...
      function n(H, M) {
        ...
        this.addDebugValues = function (O) {
          ...
          O.dataLayer = JSON.parse(
            JSON.stringify(this.dataLayer.values, function (i, Q) {
      ...
      if (
        "matomoTagManagerAsyncInit" in a &&
        B.isFunction(a.matomoTagManagerAsyncInit)
      ) {
    ...
    Templates["MatomoTag"] = (function () {
      ...
      function loadMatomo() {
          ...
          window.Matomo = window.Piwik = (function () {
            ...
            var w = {
              ...
              findPieceNode: function (au) {
                var at;
                at = ai.findFirstNodeHavingAttribute(
                  au,
              ...
              findTargetNodeNoDefault: function (at) {
                ...
                au = ai.findFirstNodeHavingAttribute(
                  at,
                  this.CONTENT_TARGET_ATTR
                );
                if (au) {
              ...
              findContentName: function (au) {
                ...
                if (ax) {
                  return ai.getAttributeValueFromNode(
                    ax,
                    this.CONTENT_NAME_ATTR
                  );
                }
              ...
              findContentTarget: function (av) {
                ...
                if (
                  ai.hasNodeAttributeWithValue(aw, this.CONTENT_TARGET_ATTR)
                ) {
                  return ai.getAttributeValueFromNode(
                    aw,
                    this.CONTENT_TARGET_ATTR
              ...
              findMediaUrlInNode: function (ax) {
                ...
                if (
                  at === "object" &&
                  ai.hasNodeAttributeWithValue(ax, "data")
                ) {
                ...
                if (at === "object") {
                  ...
                  if (ay && ay.length) {
                    ...
                    for (au = 0; au < ay.length; au++) {
                      if (
                        "movie" ===
                          ai.getAttributeValueFromNode(ay[au], "name") &&
              ...
              shouldIgnoreInteraction: function (at) {
                if (
                  ai.hasNodeAttribute(at, this.CONTENT_IGNOREINTERACTION_ATTR)
                ) {
                  return true;
                }
                if (
                  ai.hasNodeCssClass(at, this.CONTENT_IGNOREINTERACTION_CLASS)
                ) {
                  return true;
                }
                if (
            ...
            function T(co, ci) {
              ...
              function cU(dC) {
                ...
                return (
                  dC && (dC.length > 2000 || dC.indexOf('{"requests"') === 0)
                );
              }
              function aP() {
                return (
              ...
              function aE(dD) {
                ...
                var dE =
                  typeof h.timing === "object" && h.timing
                    ? h.timing
                    : undefined;
                if (!dE) {
                  dE =
                ...
                if (dE.responseStart && dE.requestStart) {
                  ...
                  dC +=
                    "&pf_srv=" + Math.round(dE.responseStart - dE.requestStart);
                }
                if (dE.responseStart && dE.responseEnd) {
                  ...
                  dC +=
                    "&pf_tfr=" + Math.round(dE.responseEnd - dE.responseStart);
                }
                if (M(dE.domLoading)) {
                  if (dE.domInteractive && dE.domLoading) {
                    ...
                    dC +=
                      "&pf_dm1=" +
                      Math.round(dE.domInteractive - dE.domLoading);
                  }
                } else {
                  if (dE.domInteractive && dE.responseEnd) {
                    ...
                    dC +=
                      "&pf_dm1=" +
                      Math.round(dE.domInteractive - dE.responseEnd);
                  }
                }
                if (dE.domComplete && dE.domInteractive) {
                  ...
                  dC +=
                    "&pf_dm2=" + Math.round(dE.domComplete - dE.domInteractive);
                }
                if (dE.loadEventEnd && dE.loadEventStart) {
                  ...
                  dC +=
                    "&pf_onl=" +
                    Math.round(dE.loadEventEnd - dE.loadEventStart);
                }
                return dD + dC;
              }
              function cm(dC) {
                return (
                  e(dC, "ignore_referrer") === "1" ||
                  e(dC, "ignore_referer") === "1"
                );
              }
              function ds() {
                var dM,
              ...
              function cr(dH) {
                ...
                if (!bl) {
                  for (dC = 0; dC < dF.length; dC++) {
                    dE = dF[dC];
                    if (
                      Object.prototype.hasOwnProperty.call(J, b3(dE, "hidden"))
                    ) {
        ...
        (function () {
          ...
          var o = 0;
          var E = false;
          var d = { play: 50, pause: 25, resume: 25, finish: 50, seek: 50 };
          var M = function () {
            return { play: 0, pause: 0, resume: 0, finish: 0, seek: 0 };
          };
          var m = { play: 50, pause: 100, resume: 100, finish: 50, seek: 100 };
          var j = 25;
          var y = true;
          var u = function () {
            return "";
          ...
          function N() {
            return (
              t.getElementById("engage_video") &&
              t.getElementById("videoDisplay1_wrapper")
            );
          }
          function b() {
          ...
          var g = { AUDIO: "Audio", VIDEO: "Video" };
          var J = {
            getLocation: function () {
              var W = this.location || G.location;
              if (!W.origin) {
                W.origin =
                  W.protocol + "//" + W.hostname + (W.port ? ":" + W.port : "");
              }
              return W;
            },
            ...
            makeUrlAbsolute: function (X) {
              ...
              if (X.indexOf("#") === 0 || X.indexOf("?") === 0) {
                return (
                  this.getLocation().origin + this.getLocation().pathname + X
                );
              }
              if ("" === X) {
                return this.getLocation().href;
              ...
              var Y =
                this.getLocation().origin +
                this.getLocation().pathname.match(new RegExp(W))[0];
              return Y + X;
            },
          };
          var T = {
          ...
          var p = {
            ...
            isFullscreen: function (W) {
              if (
                (W && t.fullScreenElement === W) ||
                t.mozFullScreenElement === W ||
                t.webkitFullscreenElement === W ||
                t.msFullscreenElement === W
              ) {
                return true;
              }
              return false;
            ...
            if (W && W.length) {
              ...
              for (Y; Y < W.length; Y++) {
                ...
                if (
                  ab &&
                  ab.MediaAnalytics &&
                  ab.MediaAnalytics.isTrackEventsEnabled()
                ) {
                  if (
                    L.isEventsLimitReached(ab, Z, ac, this.mediaLengthInSeconds)
                  ) {
                    f("Event limit reached for event: " + ac);
                    continue;
                  }
                  if (
                    "function" === typeof ab.queueRequest &&
                    "function" === typeof ab.disableQueueRequest
                  ) {
                    ab.queueRequest(aa);
                  } else {
                    ab.trackRequest(aa);
          ...
          l.prototype.trackProgress = function (
            aa,
            ac,
            ab,
            X,
            ...
            if (al && al.length) {
              ...
              for (aj; aj < al.length; aj++) {
                ...
                if (
                  Z &&
                  Z.MediaAnalytics &&
                  Z.MediaAnalytics.isTrackProgressEnabled()
                ) {
                  if (
                    "function" === typeof Z.queueRequest &&
                    "function" === typeof Z.disableQueueRequest
                  ) {
                    Z.queueRequest(ah);
                  } else {
                    Z.trackRequest(ah);
          ...
          l.prototype.play = function () {
            ...
            if (e && this.timeToInitialPlay === null) {
              this.timeToInitialPlay = T.roundTimeToSeconds(
                T.getCurrentTime() - T.getTimeScriptLoaded()
              );
            }
            e = false;
            if (this.isPaused) {
          ...
          l.prototype.trackUpdate = function () {
            ...
            for (Y = 0; Y < this.viewedSegments.length; Y++) {
              ...
              if (ab >= 0 && ab <= ac) {
                ...
                if (
                  -1 === T.indexOfArray(X, ab) &&
                  -1 === T.indexOfArray(this.trackedSegments, ab)
                ) {
                  X.push(ab);
          ...
          var L = {
            isEventsLimitReached: function (Z, X, Y, W) {
              ...
              if (
                L.getTotalEventsOnTracker(Z, Y) >=
                L.getTotalAllowedEventsPerTracker(Y)
              ) {
                f("blocked due to max tracker limit reached for action: " + Y);
                return true;
              }
              var aa =
                W && W > 900 && (Y === "pause" || Y === "resume") ? 2 : 1;
            ...
            initializeLimitPerTrackerPerMediaResource: function (Y, W, X) {
              ...
              if (
                typeof Y.MediaAnalytics.quotaEventRequests[W] === "undefined"
              ) {
                Y.MediaAnalytics.quotaEventRequests[W] = M();
              }
              if (
                typeof Y.MediaAnalytics.quotaEventRequests[W][X] === "undefined"
              ) {
          ...
          var c = {
            ...
            registerPlayer: function (W, X) {
              if (
                !X ||
                !X.scanForMedia ||
                "function" !== typeof X.scanForMedia
              ) {
                throw new Error(
            ...
            function ad() {
              if (am) {
                ...
                if ("undefined" !== typeof at.videoHeight && at.videoHeight) {
                  ...
                  if (
                    "undefined" !== typeof at.clientHeight &&
                    at.clientHeight
                  ) {
                ...
                if (ay) {
                  try {
                    ...
                    if (at && at.getPlaylistItem) {
                      ...
                      if (
                        au &&
                        "undefined" !== typeof au.matomoResource &&
                        au.matomoResource
                      ) {
                        ...
                        if (
                          au &&
                          "undefined" !== typeof au.piwikResource &&
                          au.piwikResource
                        ) {
              ...
              if (n()) {
                ...
                if (ar) {
                  ...
                  if (
                    at &&
                    at.video &&
                    "undefined" !== typeof at.video.matomoResource &&
                    ...
                    if (
                      at &&
                      at.video &&
                      "undefined" !== typeof at.video.piwikResource &&
                      at.video.piwikResource
                    ) {
          ...
          S.scanForMedia = function (Z) {
            ...
            for (var Y = 0; Y < ad.length; Y++) {
              if (!p.isMediaIgnored(ad[Y])) {
                ...
                if (
                  X !== "video_0" &&
                  Z.querySelector("#videoPlayerWrapper_0") &&
                  Z.querySelector("#video_0")
                ) {
                  continue;
                }
                new S(ad[Y], g.VIDEO);
            ...
            if (
              ...
              for (var Y in soundManager.sounds) {
                if (
                  Object.prototype.hasOwnProperty.call(soundManager.sounds, Y)
                ) {
          ...
          var s = function (Z, ac) {
            ...
            var aa =
              !p.getAttribute(Z, "data-piwik-title") &&
              !p.getAttribute(Z, "data-matomo-title");
            if (ae) {
              af.setMediaTitle(ae);
            }
            ...
            var X = function (ai) {
              if (
                !/^(https?:)?\/\/(player.)?vimeo.com(?=$|\/)/.test(ai.origin)
              ) {
                return false;
              }
              if (!ai || !ai.data) {
              ...
              if (
                ("event" in aj && aj.event === "ready") ||
                ("method" in aj && aj.method === "ping")
              ) {
                if (ab === "*") {
                  ab = ai.origin;
                }
              ...
              if ("event" in aj) {
                ...
                if (af && aj && aj.seconds) {
                  if (
                    af.getMediaProgressInSeconds() === aj.seconds &&
                    (ag === "playProgress" || ag === "timeupdate")
                  ) {
                    return;
                  }
          ...
          s.scanForMedia = function (Y) {
            ...
            for (var W = 0; W < X.length; W++) {
              ...
              if (
                Z &&
                (Z.indexOf("player.vimeo.com") > 0 ||
                  (Z.indexOf("vimeo.com") > 0 && Z.indexOf("embed") > 0))
              ) {
                new s(X[W], g.VIDEO);
              }
            }
          ...
          var w = function (ab, ae) {
            ...
            if (
              typeof Plyr === "function" &&
              p.getFirstParentWithClass(ab, "plyr", 2)
            ) {
              return;
            }
            ...
            var aa = null;
            var ad =
              !p.getAttribute(ab, "data-piwik-title") &&
              !p.getAttribute(ab, "data-matomo-title");
            var W = false;
            var ac = false;
            var af = null;
            function Z(ai) {
                ...
                case YT.PlayerState.PAUSED:
                  setTimeout(function () {
                    if (
                      am &&
                      am.getPlayerState &&
                      am.getPlayerState() == YT.PlayerState.PAUSED
                    ) {
                      if (am && am.getCurrentTime) {
                        ah.setMediaProgressInSeconds(am.getCurrentTime());
                      }
              ...
              events: {
                onReady: function (ai) {
                  ...
                  if (
                    ...
                    ai.target.getPlayerState() == YT.PlayerState.PLAYING
                  ) {
                    Z(ai);
                  }
                },
          ...
          w.scanForMedia = function (ae) {
            ...
            for (var aa = 0; aa < ad.length; aa++) {
              ...
              if (
                W &&
                (W.indexOf("youtube.com") > 0 ||
                  W.indexOf("youtube-nocookie.com") > 0)
              ) {
            ...
            function X(ai, ah) {
              ...
              try {
                if (
                  aj.toString &&
                  aj.toString().indexOf("function replaceMe") === 0
                ) {
                  return;
                }
              } catch (ag) {}
            ...
            function Z() {
              ...
              for (var ag = 0; ag < af.length; ag++) {
                ...
                if (
                  ah &&
                  (ah.indexOf("youtube.com") > 0 ||
                    ah.indexOf("youtube-nocookie.com") > 0)
                ) {
          ...
          var H = function (Z, aj) {
            ...
            function ag(an) {
              ...
              if (an.duration) {
                al.setMediaTotalLengthInSeconds(
                  parseInt(Math.floor(an.duration / 1000))
                );
              }
              al.trackUpdate();
            }
            ...
            function af(an) {
              if (
                "object" === typeof an &&
                "undefined" !== typeof an.currentPosition
              ) {
                al.setMediaProgressInSeconds(
                  parseInt(Math.floor(an.currentPosition / 1000))
                );
              }
            }
            var ac = false;
            am.bind(SC.Widget.Events.READY, function (an) {
              ...
              am.bind(SC.Widget.Events.PAUSE, function (ao) {
                ...
                af(ao);
                if (
                  al.getMediaProgressInSeconds() &&
                  al.getMediaTotalLengthInSeconds() ===
                    al.getMediaProgressInSeconds()
                ) {
                  f("ignoring pause event because video is finished");
                  return;
          ...
          function z() {
            if (
              ...
              "function" === typeof G.piwikMediaAnalyticsAsyncInit
            ) {
              G.piwikMediaAnalyticsAsyncInit();
            }
            if (
              typeof window === "object" &&
              "function" === typeof G.matomoMediaAnalyticsAsyncInit
            ) {
          ...
          function R() {
            if (
              "object" === typeof G &&
              "object" === typeof G.Piwik &&
              "object" === typeof G.Piwik.MediaAnalytics
            ) {
              return;
            }
            ...
            Piwik.MediaAnalytics = {
              ...
              setPingInterval: function (Y) {
                if (10 > Y) {
                  throw new Error(
                    "Ping interval needs to be at least ten seconds"
                  );
                }
                O = true;
                F = parseInt(Y, 10);
              ...
              log: function (aa) {
                ...
                if (Y && Y.length) {
                  for (var Z = 0; Z < Y.length; Z++) {
                    if (
                      typeof Y[Z].MediaAnalytics.quotaEventRequests !==
                        "undefined" &&
                      Object.keys(Y[Z].MediaAnalytics.quotaEventRequests)
                        .length > 0
                    ) {
              ...
              if (A && A.length) {
                ...
                for (B; B < A.length; B++) {
                  ...
                  if (D.noOfFormRequestsSent > o) {
                    e(
                      "maximum number of form request allowed for a tracker reached"
                    );
                    continue;
                  }
                  if (
                    E &&
                    500 === D.getLinkTrackingTimer() &&
                    D.setLinkTrackingTimer
                  ) {
              ...
              (function (B) {
                return function () {
                  ...
                  if (B.firstFieldEngagementDate) {
                    ...
                    e(
                      "time off not engaged " + B.timeOffWindowBeforeEngagement
                    );
                  }
                };
              })(this)
            ...
            function A(E, C, G) {
              if (
                ...
                if (
                  ...
                  c.getTagName(E) === "select" &&
                  c.hasClass(E, "select2-hidden-accessible") &&
                  E.nextSibling
                ) {
                  if (C === "focus") {
                    C = "select2:open";
              ...
              log: function (F) {
                ...
                for (var B = 0; B < A.length; B++) {
                  ...
                  if (
                    D &&
                    D.shouldBeTracked() &&
                    v.indexOfArray(D.initialFormViewLoggedWithTrackers, C) ===
                      -1
                  ) {
                    ...
                    if (D.formViewId !== null) {
                      E +=
                        ...
                        B +
                        "][fa_vid]=" +
                        encodeURIComponent(D.formViewId);
                    }
                    if (D.formId !== null) {
                      E +=
                        "&fa_fp[" +
        ...
        (function () {
          ...
          var e = {
            ...
            _matchesAttribute: function (q, o) {
              ...
              switch (p) {
                case k.TARGET_ATTRIBUTE_URL:
                case k.TARGET_ATTRIBUTE_PATH:
                  return this._matchesTargetValue(
                    o,
                    q.type,
                    q.inverted,
                    q.value
          ...
          var k = function (p) {
            ...
            if (
              ...
              typeof this.options.trigger !== "function"
            ) {
            ...
            this._getVariationDefaultPercentage = function () {
              ...
              for (var w = 0; w < this.variations.length; w++) {
                ...
                if (
                  v &&
                  (v.percentage || v.percentage === 0 || v.percentage === "0")
                ) {
            ...
            this.shouldTrigger = function () {
              ...
              if (
                !e.matchesDate(new Date(), this.startDateTime, this.endDateTime)
              ) {
                m(this.name, "wont run, scheduled date does not match");
                return false;
              }
              if (
                !e.matchesTargets(this.includedTargets, this.excludedTargets)
              ) {
          ...
          callbacks.push(function () {
            ...
            if (variableName in configuredTrackers) {
              ...
              if (
                ...
                typeof window.Matomo.FormAnalytics.disableFormAnalytics ===
                  "function"
              ) {
              ...
              if (
                ...
                typeof window.Matomo.MediaAnalytics.disableMediaAnalytics ===
                  "function"
              ) {
            ...
            if (
              possiblyUpdatedMatomoUrl &&
              lastMatomoUrl !== possiblyUpdatedMatomoUrl
            ) {
              tracker.setTrackerUrl(
                possiblyUpdatedMatomoUrl + matomoConfig.trackingEndpoint
              );
            ...
            if (
              ...
              for (
                dimIndex = 0;
                dimIndex < matomoConfig.customDimensions.length;
                dimIndex++
              ) {
                var dimension = matomoConfig.customDimensions[dimIndex];
                if (
                  dimension &&
                  TagManager.utils.isObject(dimension) &&
                  dimension.index &&
                  (dimension.value || dimension.value === null)
                ) {
            ...
            if (tracker) {
              ...
              if (trackingType === "pageview") {
                ...
                if (matomoConfig.customCookieTimeOutEnable) {
                  tracker.setVisitorCookieTimeout(
                    matomoConfig.customCookieTimeOut * 86400
                  );
                }
        ...
        tags: [
          {
            ...
            parameters: {
              matomoConfig: {
                ...
                defaultValue: "",
                parameters: {
                  matomoUrl: "https://olofsandell.matomo.cloud/",
                  idSite: 1,
